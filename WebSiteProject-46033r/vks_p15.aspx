<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vks_p15.aspx.cs" Inherits="vks_p15" %>
...
<head runat="server">
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>Търсене на практика 1</title>
...
<body>
	...
	<a href="vks_p15.htm" style="text-decoration: none"><font color="#000000"><span style="text-decoration: none">Съдебна практика</span></font></a><span lang="en-us"> |</span> 
...
// --></script>
                            ...
                            <td valign="top">&nbsp;<div align="left">
                                <table dir="ltr" border="0" cellpadding="0" cellspacing="0" width="97%" style="border: 1px dotted #C0C0C0; font-size: 8pt; font-family: Arial" bgcolor="#F9F8F0">
                                    <tr>
                                        <td valign="top" style="text-align: center">
                                            <p style="margin-left: 20pt; margin-right: 20pt; margin-top: 5pt; margin-bottom: 1pt">
                                                <font color="#800000" size="5">
<span style="text-decoration: none; font-weight: 700"><a href="vks_p15.htm" style="text-decoration: none">
<font color="#008000" face="Times New Roman">
<span style="text-decoration: none">Търсене чрез задаване на деловодни данни <br>
и референтни показатели</span></font></a></span></font>
                                            </p>
                                            <p style="margin-left: 20pt; margin-right: 20pt; margin-top: 0; margin-bottom: 5pt">
                                                <font style="font-size: 9pt">Тази форма е предназначена за търсене на съдебна практика. Чрез нея може да се 
търси чрез задаване на деловодни&nbsp; и/или&nbsp; референтни показатели.</font>
                                            </p>
                                            <div align="center">
                                                <table border="1" style="border-collapse: collapse; border-color: #808080" width="90%" bgcolor="#BFFFCC">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <p style="text-align: justify; margin-left: 10pt; margin-right: 10pt; margin-top: 0; margin-bottom: 5pt">
                                                                <font color="#000000">
<span style="font-size: 9pt">Първоначално се извежда форма чрез която могат да бъдат задавани <u>
<b onclick="FP_openNewWindow('400', '315', false, false, false, false, true, true, 'Information', /*href*/'vks_p15_docsA.htm')">деловони</b></u> и <u> 
<b onclick="FP_openNewWindow('370', '470', false, false, false, false, true, true, '', /*href*/'vks_p15_docsB.htm')">референтни</b></u> 
параметри за търсене. Попълнете един или няколко критерия за търсене, 
след което използвайте бутона Търсене. </span></font>
                                                            </p>
                                                            <p style="text-align: justify; margin-left: 10pt; margin-right: 10pt; margin-top: 0; margin-bottom: 3pt">
                                                                <font color="#000000"><span style="font-size: 9pt">Ще бъде изведен 
Резултатен списък, в горният край на който ще са видими критериите<span lang="en-us">,
</span>които са зададени при търсенето. Ще бъдат включени първите 250 
акта отговарящи на всички зададени критерии. Първата колона (в син цвят) 
съдържа номер на акта и номера на делото. Текстът е препратка към 
съдържанието на самият акт. &nbsp;Втората колона (в зелен цвят) съдържа 
ключовите фрази, аташирани към съответния съдебен акт и може да се ползва 
за бърза ориентация за други проблеми, които засяга самия акт. </span>
</font>
                                                            </p>
                                                            <p style="text-align: center; margin-left: 10pt; margin-right: 10pt; margin-top: 0; margin-bottom: 3pt">
                                                                <font color="#800000">
<span style="font-size: 9pt; font-weight: 700">
<u onclick="FP_openNewWindow('900', '900', false, false, false, false, true, true, 'Info', /*href*/'2013_03_04_Search_Instruction_full.pdf')">Подробни инструкции за 
тъсене&nbsp;</u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
<u onclick="FP_openNewWindow('650', '599', false, false, false, false, true, true, 'Info', /*href*/'vks_p15_docsC.htm')">Описание на полетата (критериите) за търсене</u></span></font>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="cnt">
                                                <iframe src="http://domino.vks.bg/bcap/scc/webdata.nsf/advancedsearch" width="95%" height="650" style="border: 1px dotted #C0C0C0; padding: 0; font-family: Arial; font-size: 8pt" name="I1" frameborder="0" border="0" />
